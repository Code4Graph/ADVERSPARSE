...
parser.add_argument('--addaptadj', action='store_true',help='whether add adaptive adj', default=True) #attention
...
parser.add_argument('--admm_training',type=bool,default=False,help='admm training')
...
def main():
    ...
    engine = trainer(scaler, args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
                         ...
                         adjinit, args.pretrain, args.admm_training)
